...
public class Client {
    ...
    public Client() {
        ...
        this.gameplay.addOption(new MenuOption("Resign (you lose the game)", () -> serverFacade.resignGame(this.authToken, this.gamesManager.getCurrentGameID(), this.postlogin)));
    }
